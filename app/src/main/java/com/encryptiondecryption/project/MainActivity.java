                                                ...
                                                public void onClick(DialogInterface dialog, int id) {
                                                    try {
                                                        ...
                                                        if (encryptedAlgorithm.equals("Caesar Cipher Algorithm")) {
                                                            ...
                                                            setKey(edt_key.getText().toString());
                                                            KeyGen();
                                                            String key_input = edt_message.getText().toString();
                                                            if (key_input.length() % 2 == 0) {
                                                                encryptedString = encryptMessage(key_input);
                ...
                try {
                    ...
                    if (edt_decyption_message.getText().toString().isEmpty()) {
                        ...
                        if (decryptedAlgorithm.equals("Caesar Cipher Algorithm")) {
                            ...
                            final_decrypted_text.setText("Decrypt Message : \n" + decryptMessage(edt_decyption_message.getText().toString()));
                        } else if (decryptedAlgorithm.equals("Vigenere Cipher Algorithm")) {
                            final_decrypted_text.setText("Decrypt Message : \n" + originalText(edt_decyption_message.getText().toString(), edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString() + edt_decryption_key.getText().toString()));
                        }
                    }
